...
func init() {
	...
	_jsii_.RegisterStruct(
		"telemetryistioio.TelemetrySpecAccessLoggingFilter",
		reflect.TypeOf((*TelemetrySpecAccessLoggingFilter)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"telemetryistioio.TelemetrySpecAccessLoggingMatch",
		reflect.TypeOf((*TelemetrySpecAccessLoggingMatch)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
		"telemetryistioio.TelemetrySpecAccessLoggingMatchMode",
		reflect.TypeOf((*TelemetrySpecAccessLoggingMatchMode)(nil)).Elem(),
		map[string]interface{}{
			"CLIENT_AND_SERVER": TelemetrySpecAccessLoggingMatchMode_CLIENT_AND_SERVER,
			"CLIENT": TelemetrySpecAccessLoggingMatchMode_CLIENT,
			"SERVER": TelemetrySpecAccessLoggingMatchMode_SERVER,
		},
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"telemetryistioio.TelemetrySpecTracingMatch",
		reflect.TypeOf((*TelemetrySpecTracingMatch)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
		"telemetryistioio.TelemetrySpecTracingMatchMode",
		reflect.TypeOf((*TelemetrySpecTracingMatchMode)(nil)).Elem(),
		map[string]interface{}{
			"CLIENT_AND_SERVER": TelemetrySpecTracingMatchMode_CLIENT_AND_SERVER,
			"CLIENT": TelemetrySpecTracingMatchMode_CLIENT,
			"SERVER": TelemetrySpecTracingMatchMode_SERVER,
		},
	)
	_jsii_.RegisterStruct(
