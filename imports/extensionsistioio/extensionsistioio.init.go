...
func init() {
	...
	_jsii_.RegisterStruct(
		"extensionsistioio.WasmPluginSpecVmConfig",
		reflect.TypeOf((*WasmPluginSpecVmConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"extensionsistioio.WasmPluginSpecVmConfigEnv",
		reflect.TypeOf((*WasmPluginSpecVmConfigEnv)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
		"extensionsistioio.WasmPluginSpecVmConfigEnvValueFrom",
		reflect.TypeOf((*WasmPluginSpecVmConfigEnvValueFrom)(nil)).Elem(),
		map[string]interface{}{
			"INLINE": WasmPluginSpecVmConfigEnvValueFrom_INLINE,
			"HOST": WasmPluginSpecVmConfigEnvValueFrom_HOST,
		},
	)
}
